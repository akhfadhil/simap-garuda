...
- Fondasi awal `../simap-partai-template` sudah dibuat dengan `config/party.php`, `PartyConfig`, `PartyScopeService`, migration fresh/squashed awal, README, dan dokumen operasional awal.
...
3. Lanjutkan batch kecil berikutnya: pilih satu area saja, misalnya skeleton Laravel minimal atau pemindahan model inti.
